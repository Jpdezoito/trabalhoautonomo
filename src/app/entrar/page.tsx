    ...
    <div className="min-h-screen bg-[#f4f7f9]">
      ...
      <main className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-6xl place-items-center px-4 py-10">
        <section className="w-full max-w-md rounded-[8px] border border-[#dbe5e1] bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm leading-6 text-[#52616b]">Use seu e-mail para acessar orcamentos, favoritos, perfil profissional ou administracao.</p>
          {process.env.NODE_ENV !== "production" ? (
            <div className="mt-4 grid gap-2 rounded-[8px] border border-[#dbe5e1] bg-[#f8fbfa] p-4 text-sm text-[#334e68]">
              <p className="font-bold text-[#0f6b5f]">Diagnostico local</p>
              <p>No localhost, este projeto nao exige captcha ou Cloudflare Turnstile no fluxo de login.</p>
              <p>
                Banco de dados:{" "}
