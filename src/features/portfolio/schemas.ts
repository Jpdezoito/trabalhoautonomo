...
export const portfolioImageFileSchema = z
  ...
  .refine((file) => file.size <= 3 * 1024 * 1024, "A imagem deve ter no máximo 3 MB.");

export const portfolioItemSchema = z.object({
  title: z.string().min(3, "Informe um titulo com pelo menos 3 caracteres.").max(90, "Use no máximo 90 caracteres."),
